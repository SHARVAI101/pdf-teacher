...
function Home() {
  return (
    <div class="bg-gradient-to-b from-[#101212] relative to-[#08201D]">
        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <div class="lg:flex lg:items-center lg:justify-end lg:space-x-6 sm:ml-auto">
              <a href="/login" title="" class="hidden text-base text-white transition-all duration-200 lg:inline-flex hover:text-opacity-80"> Log in </a>

              <a href="/register" title="" class="inline-flex items-center justify-center px-3 sm:px-5 py-2.5 text-sm sm:text-base font-semibold transition-all duration-200 text-white bg-white/20 hover:bg-white/40 focus:bg-white/40 rounded-lg" role="button"> Apply for free </a>
            </div>
      ...
      <section class="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-48 sm:pb-16 lg:pb-24">
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
          <div class="max-w-xl mx-auto text-center">
            ...
            <a href="/register" title="" class="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-lg sm:mt-16 hover:bg-blue-700 focus:bg-blue-700" role="button">
              Apply for free
